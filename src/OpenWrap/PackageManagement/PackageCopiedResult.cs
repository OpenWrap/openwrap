...
{
    public class PackageCopiedResult : PackagePublishedResult
    {
        public PackageCopiedResult(IPackageInfo previousPackage, IPackageInfo package, ISupportPublishing repository)
