...
namespace OpenWrap.Services
{
    ...
    {
        //public IEnumerable<IAssemblyReferenceExportItem> GetAssemblyReferences(PackageDescriptor descriptor, IPackageRepository repository, IPackageAssembliesClient client)
        //{
