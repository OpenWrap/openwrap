...
namespace OpenWrap.Repositories
{
    public class UncompressedPackage : IPackage
    {
            ...
            IEnumerable<IExportBuilder> exporters)
        {
            ...
            Descriptor = new DefaultPackageInfo(originalPackage.Name, versionFile.Exists ? versionFile.Read(x=>x.ReadString().ToVersion()) : null, new PackageDescriptorReaderWriter().ParseFile(wrapDescriptor));
        }
