...
//        System.Windows.Forms.Command _command;
...
//                    commandBarEvents = (CommandBarEvents)dte.Events.CommandBarEvents[control];
...
//    {
//        public QueryStatusEventArgs(DTE2 application, AddIn @in, string commandName, vsCommandStatusTextWanted textWanted, vsCommandStatus commandStatus, object commandText)
//            : base(application, @in)
//        {
...
//        public ExecEventArgs(DTE2 application, AddIn addIn, string cmdName, vsCommandExecOption executeOption, object variantIn, object variantOut, bool handled)
//            : base(application, addIn)
//        {
//            CommandName = cmdName;
...
//    {
//        public DisconnectionEventArgs(DTE2 application, AddIn addIn, ext_DisconnectMode mode)
//            : base(application, addIn)
//        {
//            DisconnectMode = mode;
//        }
...
//    {
//        public ConnectionEventArgs(DTE2 application, AddIn @in, ext_ConnectMode mode)
//            : base(application, @in)
//        {
//            ConnectMode = mode;
//        }
