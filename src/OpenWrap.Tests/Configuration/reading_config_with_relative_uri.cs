...
{
    public class reading_config_with_relative_uri : configuration<reading_config_with_absolute_uri.ConfigurationWithAttribute>
    {
        public reading_config_with_relative_uri()
        {
