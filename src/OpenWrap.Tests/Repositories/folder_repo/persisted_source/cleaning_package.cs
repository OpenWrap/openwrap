...
{
    public class cleaning_package : contexts.folder_repository
    {
    ...
    [Ignore]
    public class importing_existing_package_unknown_source : contexts.folder_repository
    {
        public importing_existing_package_unknown_source()
        {
            given_folder_repository(FolderRepositoryOptions.PersistPackageSources);
            given_package_file("test", "1.0.0");
            when_cleaning_package("test", "1.0.0");
        }
